#include "mecabot_base.h"

MecabotBase::MecabotBase():
  linear_vel_x_(0),
  linear_vel_y_(0),
  angular_vel_z_(0),
  last_vel_time_(0),
  ...
  heading_(0)
{
  ...
  vel_subscriber_ = nh_.subscribe("raw_vel", 50, &MecabotBase::velCallback, this);
}

void MecabotBase::velCallback(const geometry_msgs::Twist& vel)
{
